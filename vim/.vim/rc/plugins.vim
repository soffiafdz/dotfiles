" Plugins and their settings, sourced by ~/.vimrc.
"
" Not cluster-safe by design: vim-plug installs over the network and writes
" thousands of files under ~/.vim/plugged. ~/.vimrc skips this file when
" $CC_CLUSTER is set or vim-plug is absent.
